...
Return Trim(text) 
End Function
Dim Shared As String thatmsg000,topicprev000,topicnext000,msgprocess000,msgmsg000,outmsg000
...
If testproc=1 Then 
	...
	For j=1 To 30
	 If InStr(msg,"/rnd/")>0 Then
	 	k=InStr(msg,"/rnd/")
	 	l=InStr(msg,"/rnd2/")
	 	If l<1 Then Var msg1=msg:l=Len(msg1)
...
Else 	
	...
	msgmsg=msgmsg+crlf+"> "+msgprocess
EndIf
printgui("win.msg",msgmsg000+msgmsg)
End Sub
