...
Dim Shared As Integer itime,restart=0,icombo=2,icomboaiml=1
...
Sub saveinput000()
thatmsg000=thatmsg:topicprev000=topicprev:topicnext000=topicnext':msgprocess000=msgprocess:msgmsg000=msgmsg
End Sub
Sub restoreinput000()
thatmsg=thatmsg000:topicprev=topicprev000:topicnext=topicnext000':msgprocess=msgprocess000:msgmsg=msgmsg000
End Sub
Sub mysubaiml()
...
myinputtext=inputtext
   msgmsg000=""
	If myinputtext<>"" Then
		...
		If myinputtext="*" Then
			saveinput000()
			myinputtext=oldmsg'autochat
   		myinputtext=formatinput(myinputtext)
   		msgmsg000=Mid(msgmsg,InStrRev(msgmsg,">")+1)+crlf
